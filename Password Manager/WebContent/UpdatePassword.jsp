        ...
        <div class="wrapper fadeInDown" style="display: flex;
            ...
            <div align="center" class="formContent" style="
              ...
              text-align: center;"><br>
                ...
                <input type="password" placeholder="Enter Password" name="newtitlepass" required><br><br>

                <button  class="btn btn-primary" 	type="submit" name="update">Update</button><br><br>
